(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))a(r);new MutationObserver(r=>{for(const i of r)if(i.type==="childList")for(const n of i.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&a(n)}).observe(document,{childList:!0,subtree:!0});function e(r){const i={};return r.integrity&&(i.integrity=r.integrity),r.referrerPolicy&&(i.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?i.credentials="include":r.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function a(r){if(r.ep)return;r.ep=!0;const i=e(r);fetch(r.href,i)}})();let o=[{id:0,name:"肥宅心碎賞櫻3日",imgUrl:"https://images.unsplash.com/photo-1522383225653-ed111181a951?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=1655&q=80",area:"高雄市",description:"賞櫻花最佳去處。肥宅不得不去的超讚景點！",group:87,price:1400,rate:10},{id:1,name:"貓空纜車雙程票",imgUrl:"https://images.unsplash.com/photo-1501393152198-34b240415948?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=1650&q=80",area:"臺北市",description:"乘坐以透明強化玻璃為地板的「貓纜之眼」水晶車廂，享受騰雲駕霧遨遊天際之感",group:99,price:240,rate:2},{id:2,name:"台中谷關溫泉會1日",imgUrl:"https://images.unsplash.com/photo-1535530992830-e25d07cfa780?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=1650&q=80",area:"臺中市",description:"全館客房均提供谷關無色無味之優質碳酸原湯，並取用八仙山之山冷泉供蒞臨貴賓沐浴及飲水使用。",group:20,price:1765,rate:7}];const y=["臺北市","新北市","桃園市","臺中市","臺南市","高雄市","新竹縣","苗栗縣","彰化縣","南投縣","雲林縣","嘉義縣","屏東縣","宜蘭縣","花蓮縣","臺東縣","澎湖縣","金門縣","連江縣","基隆市","新竹市","嘉義市"],g=document.querySelector(".ticketCard-area"),k=document.querySelector(".regionSearch"),s=document.querySelector("#searchResult-text"),p=document.querySelector("#ticketName"),f=document.querySelector("#ticketImgUrl"),l=document.querySelector("#ticketRegion"),m=document.querySelector("#ticketPrice"),v=document.querySelector("#ticketNum"),d=document.querySelector("#ticketRate"),h=document.querySelector("#ticketDescription"),C=document.querySelector("#addBtn");function b(){let c='<option value="全部">全部地區</option>',t='<option value="" disabled selected hidden>請選擇景點地區</option>';y.forEach(e=>{c+=`
    ...
    <div class="ticketCard-content">
  ...
  </li>`,t+=1}),g.innerHTML=c,s.innerHTML=`本次搜尋共 ${t} 筆資料`}u();k.addEventListener("change",c=>{const t=c.target.value;t==="全部"?u():e(t);function e(a){let r="",i=0;o.forEach(n=>{n.area===a&&(r+=` <li class="ticketCard">
        <div class="ticketCard-img">
          <a href="#">
            <img
              src="${n.imgUrl}"
      ...
      </li>`,i+=1)}),g.innerHTML=r,r=`本次搜尋共 ${i} 筆資料`,i===0?s.innerHTML=r+",找不到相關頁面":s.innerHTML=r}});function $(c){let t=0;return c.forEach(e=>{e.value.trim()===""&&(t+=1),e===d&&(Number(e.value.trim())>10||Number(e.value.trim())<1)&&(t+=1)}),t}function x(c){c.forEach(t=>{t.value=""})}C.addEventListener("click",c=>{const t=[p,f,l,h,v,m,d];if($(t)>0){alert("請檢查每個選項是否填寫/正確");return}const e=o.length;let a={};a.id=e,a.name=p.value,a.imgUrl=f.value,a.area=l.value,a.description=h.value,a.group=Number(v.value),a.price=Number(m.value),a.rate=Number(d.value),o.push(a),u(),x(t)});
